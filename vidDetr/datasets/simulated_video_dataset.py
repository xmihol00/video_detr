...
class SimulatedVideoSequenceDataset(Dataset):
    """
...
def buildVideoDataset(args) -> Tuple[Dataset, Optional[Dataset]]:
    ...
    trainDataset = SimulatedVideoSequenceDataset(
        dataRoot=trainRoot,
    ...
    if mergeTrainVal:
        ...
        valAsTrainDataset = SimulatedVideoSequenceDataset(
            dataRoot=valRoot,
            numFrames=args.numFrames,
            transforms=trainTransforms,
    ...
    valDataset = SimulatedVideoSequenceDataset(
        dataRoot=valRoot,
        numFrames=args.numFrames,
